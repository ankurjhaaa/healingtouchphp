                    ...
                    <div class="p-5">
                        <div class="grid sm:grid-cols-2 gap-6">
                            ...
                            <div class="flex items-start min-w-0">
                                <div class="bg-beige-100 p-2.5 rounded-lg mr-3 flex-shrink-0">
                            ...
                            <div class="flex items-start min-w-0">
                                <div id="wa-icon-container" class="bg-gray-100 p-2.5 rounded-lg mr-3 flex-shrink-0">
            ...
            <div class="md:col-span-1">
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden h-full">
                    <div class="p-4">
                        ...
                        <div class="aspect-video relative rounded-lg overflow-hidden border border-gray-200 min-h-[220px] sm:min-h-[300px]">
                            <iframe
                        ...
                        <div class="bg-beige-50 rounded-lg border border-beige-100 p-4 mt-4">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const checkAvailability = () => {
            ...
            if (available) {
                ...
                container.className = 'bg-green-100 p-2.5 rounded-lg mr-3 flex-shrink-0';
                ...
                container.className = 'bg-gray-100 p-2.5 rounded-lg mr-3 flex-shrink-0';
