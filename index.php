...
<div class="public-page min-h-screen bg-[#f5f7fb] md:bg-[#f8f9ff] font-sans text-gray-900 antialiased overflow-x-hidden pb-16 lg:pb-0 flex flex-col">
    ...
    <section class="relative pt-20 pb-4 sm:pb-12 md:pt-28 md:pb-16 bg-[#f5f7fb] md:bg-beige-50 overflow-hidden md:border-b md:border-gray-200">
        <div class="container mx-auto px-3 sm:px-4 flex flex-col md:flex-row items-stretch md:items-center relative z-10 w-full max-w-7xl gap-3 md:gap-0">
            <div class="md:w-1/2 mb-0 md:mb-0 px-0 md:px-4 order-2 md:order-1">
                <div class="bg-transparent border-0 rounded-none p-0 md:bg-transparent md:border-0 md:rounded-none md:p-0">
                    ...
                    <div class="hidden md:flex flex-col sm:flex-row gap-2.5">
                        <a href="/book-appointment.php" class="bg-beige-600 hover:bg-beige-700 text-white px-5 py-3 rounded-xl transition-colors duration-150 border border-beige-600 text-sm sm:text-base font-semibold flex items-center justify-center">
                            <span>Book Appointment</span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                            </svg>
                        </a>
                        <a href="/our-doctors.php" class="bg-white text-beige-700 px-5 py-3 rounded-xl border border-beige-200 text-sm sm:text-base font-semibold flex items-center justify-center hover:bg-beige-50">
                            Browse Doctors
                        </a>
                    </div>
                    <div class="md:hidden mt-3">
                        <a href="/book-appointment.php" class="rounded-xl border border-beige-600 bg-beige-600 px-4 py-3 text-sm font-black text-white shadow-sm flex items-center justify-center gap-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-3 sm:mt-6 max-w-sm">
                        <div class="flex items-center bg-white md:bg-beige-50 rounded-xl border border-gray-200 md:border-beige-100 p-2.5 shadow-sm md:shadow-none">
                            <div class="bg-beige-100 p-2 rounded-lg mr-2.5">
            ...
            <div class="md:w-1/2 relative px-0 md:px-4 pt-0 md:pt-0 order-1 md:order-2">
                <div class="relative h-[235px] sm:h-[320px] md:h-[380px] lg:h-[430px] overflow-hidden rounded-2xl border border-gray-200 shadow-sm md:shadow-none bg-gray-200">
                    <img
                        id="hero-slide-img"
                    ...
                    />
                    <div class="absolute inset-x-0 bottom-0 flex items-end justify-between bg-gradient-to-t from-black/55 to-transparent p-3 md:p-4">
                ...
                <div class="absolute bottom-3 left-3 md:-bottom-4 md:-left-4 bg-white p-2.5 rounded-lg border border-gray-200 flex items-center space-x-2 shadow-sm md:shadow-none">
        ...
        <div class="container mx-auto px-3 sm:px-4 max-w-7xl">
            ...
            <div class="flex md:grid md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 overflow-x-auto md:overflow-visible no-scrollbar snap-x">
                <?php if(count($doctors) > 0): ?>
                    ...
                    <div class="bg-white rounded-xl md:rounded-lg overflow-hidden h-full flex flex-col border border-gray-200 min-w-[82%] sm:min-w-[48%] md:min-w-0 snap-start shadow-sm md:shadow-none">
                        <div class="p-3 md:p-4 flex-grow">
                            <div class="flex items-start gap-4">
                                <div class="flex-shrink-0">
                                    <img class="w-16 h-16 md:w-20 md:h-20 rounded-lg object-cover border border-beige-200" src="<?php echo htmlspecialchars($doctor['image'] ?? '/assets/images/default.jpg'); ?>" alt="Dr. <?php echo htmlspecialchars($doctor['name']); ?>" />
                                </div>
                        ...
                        <div class="bg-gray-50 px-3 md:px-4 py-3 border-t border-gray-200 mt-auto flex gap-2">
                            ...
                            <a href="/book-appointment.php?slug=<?php echo urlencode($doctor['slug']); ?>" class="flex-1 text-center py-2 rounded-md bg-beige-600 text-white text-sm font-semibold hover:bg-beige-700 border border-beige-600">Book Now</a>
                        </div>
                    </div>
                    <?php endforeach; ?>
                <?php else: ?>
    ...
    <section class="py-6 md:py-10 bg-white">
        <div class="container mx-auto px-3 sm:px-4 max-w-7xl">
            ...
            <div class="flex md:grid md:grid-cols-3 gap-3 md:gap-5 overflow-x-auto md:overflow-visible no-scrollbar snap-x pb-1">
                <div class="bg-gray-50 md:bg-white p-4 md:p-6 rounded-xl md:rounded-lg border border-gray-200 group min-w-[82%] sm:min-w-[58%] md:min-w-0 snap-start">
                    <div class="bg-beige-100 p-2.5 md:p-3 rounded-lg inline-block mb-3 md:mb-4 group-hover:bg-beige-200 transition-colors duration-150">
    ...
    <section id="about" class="py-6 md:py-12 bg-beige-50 border-y border-gray-200">
        <div class="container mx-auto px-3 sm:px-4 max-w-7xl">
            ...
            <div class="rounded-2xl md:rounded-3xl border border-beige-100 bg-white p-3 md:p-8 shadow-sm">
                <div class="grid grid-cols-1 md:grid-cols-[1.02fr_0.98fr] gap-4 md:gap-8 items-start">
                    <div class="space-y-3 md:space-y-4">
                        <div class="relative overflow-hidden rounded-xl md:rounded-2xl border border-gray-200">
                            ...
                            <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/55 to-transparent p-3 md:p-4">
                    ...
                    <div class="rounded-xl md:rounded-2xl border border-gray-200 bg-gray-50 p-4 md:p-6">
