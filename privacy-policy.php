...
$seo_title = 'Privacy Policy - Healing Touch Hospital';
$seo_description = 'We value your trust. This policy explains how we collect, use, and protect your personal information.';
$active_page = 'privacy';
...
<div class="public-page min-h-screen bg-gray-50 font-sans text-gray-900 antialiased overflow-x-hidden pb-10 flex flex-col">
    <div class="bg-slate-900 mt-16 pt-16 pb-24 px-4 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto relative z-10 text-center">
            ...
            <p class="text-xs text-slate-500 font-bold uppercase tracking-widest">Last updated: April 23, 2026</p>
        </div>
    </div>
