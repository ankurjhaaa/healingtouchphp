...
<div
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12 w-full">
        ...
        <div class="mt-4 bg-white rounded-md border border-gray-100 shadow-sm overflow-hidden">
            <div class="bg-beige-50 border-b border-beige-100 px-5 sm:px-6 py-5">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <a href="<?php echo htmlspecialchars($LARAVEL_BOOKING_URL); ?>/?slug=<?php echo urlencode($doctor['slug']); ?>" 
                        class="inline-flex items-center justify-center bg-beige-600 hover:bg-beige-700 text-white px-5 py-3 rounded-md font-semibold shadow-sm self-start sm:self-center">
                        Book Appointment
                    </a>
                </div>
            </div>
            ...
            <div class="p-5 sm:p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-5">
                    <div class="rounded-md bg-beige-50/60 border border-beige-100 p-5">
                    ...
                    <div class="rounded-md bg-white border border-gray-100 p-5 shadow-sm">
                ...
                <div class="space-y-5">
                    ...
                    <div class="rounded-md bg-beige-600 text-white p-5 shadow-sm">
                        ...
                        <p class="text-beige-100 text-sm mb-4">Proceed to appointment booking with this doctor already
                            selected.</p>
                        <a href="<?php echo htmlspecialchars($LARAVEL_BOOKING_URL); ?>/?slug=<?php echo urlencode($doctor['slug']); ?>"
                            class="inline-flex items-center justify-center bg-white text-beige-700 hover:bg-beige-50 px-4 py-2.5 rounded-md font-semibold">
                            Continue Booking
                        </a>
                    </div>
                </div>
